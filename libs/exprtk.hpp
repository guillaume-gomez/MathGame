...
{
    enum { min_exp =  -38, max_exp =  +38};
};
template<> struct numeric_info<double>
{
    enum { min_exp = -308, max_exp = +308};
};
...
inline T process_impl(const operator_type operation, const T& arg0, const T& arg1, real_type_tag)
{
    ...
    case e_hyp    :
        return hyp<T>(arg0,arg1);
    case e_avg    :
        return (arg0 + arg1)/T(2);
    case e_sum    :
        return (arg0 + arg1);
    case e_prod   :
        return (arg0 * arg1);
...
public:
    ...
    inline T value() const
    {
        ...
        case e_min     :
            return std::min<T>(std::min<T>(arg0,arg1),arg2);
        case e_max     :
            return std::max<T>(std::max<T>(arg0,arg1),arg2);
        case e_avg     :
            return (arg0 + arg1 + arg2) / T(3.0);
        case e_sum     :
...
public:
    ...
    inline T value() const
    {
        ...
        {
        case e_min  :
            return std::min<T>(std::min<T>(arg0,arg1),std::min<T>(arg2,arg3));
        case e_max  :
            return std::max<T>(std::max<T>(arg0,arg1),std::max<T>(arg2,arg3));
        case e_avg  :
            return (arg0 + arg1 + arg2 + arg3) / T(4.0);
        case e_sum  :
...
public:
    ...
    inline T value() const
    {
        ...
        {
        case e_min  :
            return std::min<T>(std::min<T>(std::min<T>(arg0,arg1),std::min<T>(arg2,arg3)),arg4);
        case e_max  :
            return std::max<T>(std::max<T>(std::max<T>(arg0,arg1),std::max<T>(arg2,arg3)),arg4);
        case e_avg  :
            return (arg0 + arg1 + arg2 + arg3 + arg4) / T(5.0);
        case e_sum  :
...
public:
    ...
    inline T value() const
    {
        ...
        {
        case e_min     :
            return std::min<T>(std::min<T>(std::min<T>(arg0,arg1),std::min<T>(arg2,arg3)),std::min<T>(arg4,arg5));
        case e_max     :
            return std::max<T>(std::max<T>(std::max<T>(arg0,arg1),std::max<T>(arg2,arg3)),std::max<T>(arg4,arg5));
        case e_avg     :
            return (arg0 + arg1 + arg2 + arg3 + arg4 + arg5) / T(6.0);
        case e_sum     :
...
template <typename T, std::size_t N> inline T axn(T a, T x)
{
    return a * exprtk::details::numeric::fast_exp<T,N>::result(x);    // a*x^n
}
template <typename T, std::size_t N> inline T axnb(T a, T x, T b)
{
    return a * exprtk::details::numeric::fast_exp<T,N>::result(x) + b;    // a*x^n+b
}

template <typename T> struct sf00_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return (x + y) / z;
    }
};
template <typename T> struct sf01_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return (x + y) * z;
...
template <typename T> struct sf02_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return (x - y) / z;
...
template <typename T> struct sf03_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return (x - y) * z;
...
template <typename T> struct sf04_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return (x * y) + z;
...
template <typename T> struct sf05_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return (x * y) - z;
...
template <typename T> struct sf06_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return (x * y) / z;
...
template <typename T> struct sf07_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return (x * y) * z;
...
template <typename T> struct sf08_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return (x / y) + z;
...
template <typename T> struct sf09_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return (x / y) - z;
...
template <typename T> struct sf10_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return (x / y) / z;
...
template <typename T> struct sf11_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return (x / y) * z;
...
template <typename T> struct sf12_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return x / (y + z);
...
template <typename T> struct sf13_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return x / (y - z);
...
template <typename T> struct sf14_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return x / (y * z);
...
template <typename T> struct sf15_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return x / (y / z);
...
template <typename T> struct sf16_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return x - (y / z);
...
template <typename T> struct sf17_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return x - (y / z);
...
template <typename T> struct sf18_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return axnb<T,2>(x,y,z);
    }
}; //x * y^2 + z
template <typename T> struct sf19_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return axnb<T,3>(x,y,z);
    }
}; //x * y^3 + z
template <typename T> struct sf20_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return axnb<T,4>(x,y,z);
    }
}; //x * y^4 + z
template <typename T> struct sf21_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return axnb<T,5>(x,y,z);
    }
}; //x * y^5 + z
template <typename T> struct sf22_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return axnb<T,6>(x,y,z);
    }
}; //x * y^6 + z
template <typename T> struct sf23_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return axnb<T,7>(x,y,z);
    }
}; //x * y^7 + z
template <typename T> struct sf24_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return axnb<T,8>(x,y,z);
    }
}; //x * y^8 + z
template <typename T> struct sf25_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return axnb<T,9>(x,y,z);
    }
}; //x * y^9 + z
template <typename T> struct sf26_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return x * numeric::log(y)   + z;
    }
};
template <typename T> struct sf27_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return x * numeric::log(y)   - z;
...
template <typename T> struct sf28_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return x * numeric::log10(y) + z;
    }
};
template <typename T> struct sf29_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return x * numeric::log10(y) - z;
...
template <typename T> struct sf30_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return x * numeric::sin(y) + z;
    }
};
template <typename T> struct sf31_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return x * numeric::sin(y) - z;
...
template <typename T> struct sf32_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return x * numeric::cos(y) + z;
    }
};
template <typename T> struct sf33_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return x * numeric::cos(y) - z;
...
template <typename T> struct sf34_op
{
    static inline T process(const T& x, const T& y, const T& z)
    {
        return (T(0) != x) ? y : z;
...
template <typename T> struct sf35_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return x + ((y + z) / w);
    }
};
template <typename T> struct sf36_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return x + ((y + z) * w);
...
template <typename T> struct sf37_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return x + ((y - z) / w);
...
template <typename T> struct sf38_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return x + ((y - z) * w);
...
template <typename T> struct sf39_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return x + ((y * z) / w);
...
template <typename T> struct sf40_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return x + ((y * z) * w);
...
template <typename T> struct sf41_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return x + ((y / z) + w);
...
template <typename T> struct sf42_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return x + ((y / z) / w);
...
template <typename T> struct sf43_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return x + ((y / z) * w);
...
template <typename T> struct sf44_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return x - ((y + z) / w);
...
template <typename T> struct sf45_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return x - ((y + z) * w);
...
template <typename T> struct sf46_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return x - ((y - z) / w);
...
template <typename T> struct sf47_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return x - ((y - z) * w);
...
template <typename T> struct sf48_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return x - ((y * z) / w);
...
template <typename T> struct sf49_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return x - ((y * z) * w);
...
template <typename T> struct sf50_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return x - ((y / z) / w);
...
template <typename T> struct sf51_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return x - ((y / z) * w);
...
template <typename T> struct sf52_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return ((x + y) * z) - w;
...
template <typename T> struct sf53_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return ((x - y) * z) - w;
...
template <typename T> struct sf54_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return ((x * y) * z) - w;
...
template <typename T> struct sf55_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return ((x / y) * z) - w;
...
template <typename T> struct sf56_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return ((x + y) / z) - w;
...
template <typename T> struct sf57_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return ((x - y) / z) - w;
...
template <typename T> struct sf58_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return ((x * y) / z) - w;
...
template <typename T> struct sf59_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return ((x / y) / z) - w;
...
template <typename T> struct sf60_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return (x * y) + (z * w);
...
template <typename T> struct sf61_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return (x * y) - (z * w);
...
template <typename T> struct sf62_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return (x * y) + (z / w);
...
template <typename T> struct sf63_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return (x * y) - (z / w);
...
template <typename T> struct sf64_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return (x / y) + (z / w);
...
template <typename T> struct sf65_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return (x / y) - (z / w);
...
template <typename T> struct sf66_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return (x / y) - (z / w);
...
template <typename T> struct sf67_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return (x / y) - (z * w);
...
template <typename T> struct sf68_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return axn<T,2>(x,y) + axn<T,2>(z,w);
    }
}; //x*y^2+z*w^2
template <typename T> struct sf69_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return axn<T,3>(x,y) + axn<T,3>(z,w);
    }
}; //x*y^3+z*w^3
template <typename T> struct sf70_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return axn<T,4>(x,y) + axn<T,4>(z,w);
    }
}; //x*y^4+z*w^4
template <typename T> struct sf71_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return axn<T,5>(x,y) + axn<T,5>(z,w);
    }
}; //x*y^5+z*w^5
template <typename T> struct sf72_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return axn<T,6>(x,y) + axn<T,6>(z,w);
    }
}; //x*y^6+z*w^6
template <typename T> struct sf73_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return axn<T,7>(x,y) + axn<T,7>(z,w);
    }
}; //x*y^7+z*w^7
template <typename T> struct sf74_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return axn<T,8>(x,y) + axn<T,8>(z,w);
    }
}; //x*y^8+z*w^8
template <typename T> struct sf75_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return axn<T,9>(x,y) + axn<T,9>(z,w);
    }
}; //x*y^9+z*w^9
template <typename T> struct sf76_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return ((T(0) != x) && (T(0) != y)) ? z : w;
    }
};
template <typename T> struct sf77_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return ((T(0) != x) || (T(0) != y)) ? z : w;
...
template <typename T> struct sf78_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return (x <  y) ? z : w;
...
template <typename T> struct sf79_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return (x <= y) ? z : w;
...
template <typename T> struct sf80_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return (x >  y) ? z : w;
...
template <typename T> struct sf81_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return (x >= y) ? z : w;
...
template <typename T> struct sf82_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return numeric::equal(x,y) ? z : w;
    }
};
template <typename T> struct sf83_op
{
    static inline T process(const T& x, const T& y, const T& z, const T& w)
    {
        return x * numeric::sin(y) + z * numeric::cos(w);
    }
};
...
struct xor_op
{
    static inline T process(const T& t1, const T& t2)
    {
        return numeric::xor_opr<T>(t1,t2);
    }
    static inline typename expression_node<T>::node_type type()
    {
        return expression_node<T>::e_nor;
...
private:
    ...
    inline expression_node_ptr parse_expression(precedence_level precedence = e_level00)
    {
        ...
        for ( ; ; )
        {
            ...
            {
            case token_t::assign :
                current_state.set(e_level00,e_level00,details::e_assign);
                break;
            case token_t::lt     :
                current_state.set(e_level05,e_level06,details::    e_lt);
                break;
            case token_t::lte    :
                current_state.set(e_level05,e_level06,details::   e_lte);
                break;
            case token_t::eq     :
                current_state.set(e_level05,e_level06,details::    e_eq);
                break;
            case token_t::ne     :
                current_state.set(e_level05,e_level06,details::    e_ne);
                break;
            case token_t::gte    :
                current_state.set(e_level05,e_level06,details::   e_gte);
                break;
            case token_t::gt     :
                current_state.set(e_level05,e_level06,details::    e_gt);
                break;
            case token_t::add    :
                current_state.set(e_level07,e_level08,details::   e_add);
                break;
            case token_t::sub    :
                current_state.set(e_level07,e_level08,details::   e_sub);
                break;
            case token_t::div    :
                current_state.set(e_level10,e_level11,details::   e_div);
                break;
            case token_t::mul    :
                current_state.set(e_level10,e_level11,details::   e_mul);
                break;
            case token_t::mod    :
                current_state.set(e_level10,e_level11,details::   e_mod);
                break;
            case token_t::pow    :
                current_state.set(e_level12,e_level12,details::   e_pow);
                break;
            default              :
                if (token_t::symbol == current_token_.type)
                {
    ...
    inline expression_node_ptr parse_special_function(const unsigned int id)
    {
        ...
        else
        {
            ...
            {
            case 3  :
                result = expression_generator_.special_function(opt_type,branch3);
                break;
            case 4  :
                result = expression_generator_.special_function(opt_type,branch4);
                break;
            default :
                return error_node();
            }
    ...
    inline expression_node_ptr parse_symbol()
    {
        ...
        if (current_token_.value.size() > 1)
        {
            for (std::size_t i = 0; i < details::operation_list_size; ++i)
            {
                if (details::imatch(details::operation_list[i].name,current_token_.value))
                {
                    ...
                    {
                    case 1 :
                        branch = parse_function_call<1>(details::operation_list[i].type);
                        break;
                    case 2 :
                        branch = parse_function_call<2>(details::operation_list[i].type);
                        break;
                    case 3 :
                        branch = parse_function_call<3>(details::operation_list[i].type);
                        break;
                    case 4 :
                        branch = parse_function_call<4>(details::operation_list[i].type);
                        break;
                    case 5 :
                        branch = parse_function_call<5>(details::operation_list[i].type);
                        break;
                    case 6 :
                        branch = parse_function_call<6>(details::operation_list[i].type);
                        break;
                    }
                    if (branch)
                    {
        ...
        else if (symbol_table_.valid())
        {
            ...
            if (function)
            {
                ...
                {
                case  0 :
                    func_node = expression_generator_.function(function);
                    break;
                case  1 :
                    func_node = parse_function_call< 1>(function);
                    break;
                case  2 :
                    func_node = parse_function_call< 2>(function);
                    break;
                case  3 :
                    func_node = parse_function_call< 3>(function);
                    break;
                case  4 :
                    func_node = parse_function_call< 4>(function);
                    break;
                case  5 :
                    func_node = parse_function_call< 5>(function);
                    break;
                case  6 :
                    func_node = parse_function_call< 6>(function);
                    break;
                case  7 :
                    func_node = parse_function_call< 7>(function);
                    break;
                case  8 :
                    func_node = parse_function_call< 8>(function);
                    break;
                case  9 :
                    func_node = parse_function_call< 9>(function);
                    break;
                case 10 :
                    func_node = parse_function_call<10>(function);
                    break;
                case 11 :
                    func_node = parse_function_call<11>(function);
                    break;
                case 12 :
                    func_node = parse_function_call<12>(function);
                    break;
                case 13 :
                    func_node = parse_function_call<13>(function);
                    break;
                case 14 :
                    func_node = parse_function_call<14>(function);
                    break;
                case 15 :
                    func_node = parse_function_call<15>(function);
                    break;
                case 16 :
                    func_node = parse_function_call<16>(function);
                    break;
                case 17 :
                    func_node = parse_function_call<17>(function);
                    break;
                case 18 :
                    func_node = parse_function_call<18>(function);
                    break;
                case 19 :
                    func_node = parse_function_call<19>(function);
                    break;
                case 20 :
                    func_node = parse_function_call<20>(function);
                    break;
                default :
                {
    ...
    public:
        ...
        inline bool is_level_optimizable(const std::size_t& level = 0) const
        {
            ...
            {
            case 1  :
                return (e_level1 == (optimization_level_ & e_level1));
            case 2  :
                return (e_level2 == (optimization_level_ & e_level2)) && is_level_optimizable(1);
            case 3  :
                return (e_level3 == (optimization_level_ & e_level3)) && is_level_optimizable(2);
            case 0  :
                return (e_all    == (optimization_level_ &    e_all));
            default :
                return false;
            }
        }
