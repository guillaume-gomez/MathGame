...
float EditorObject::distance(sf::Vector2f pointOne, sf::Vector2f pointTwo)
{
...
bool EditorObject::isCollide(sf::Vector2f point)
{
...
bool EditorObject::isCollide(const sf::FloatRect& rect)
{
